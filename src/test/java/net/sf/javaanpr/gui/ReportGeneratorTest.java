...
public class ReportGeneratorTest {
    ...
    /**
     * Tests {@link ReportGenerator#saveStreamToFile(InputStream, File)} with null input stream.
     *
    ...
    /**
     * Tests {@link ReportGenerator#saveStreamToFile(InputStream, File)} with null output stream input.
     *
     * @throws IllegalArgumentException the illegal argument exception
     * @throws IOException              Signals that an I/O exception has occurred.
     */
    ...
    /**
     * Tests {@link ReportGenerator#saveStreamToFile(InputStream, File)} with valid input and output
     * stream.
     *
     * @throws IllegalArgumentException the illegal argument exception
     * @throws IOException              Signals that an I/O exception has occurred.
